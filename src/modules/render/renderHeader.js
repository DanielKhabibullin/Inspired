...
export const searchButton = createElement('button', 
	{
		...
		innerHTML: `
			<svg aria-label="Поиск" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" xmlns="http://www.w3.org/2000/svg">
...
export const cartLink = createElement('a', 
	{
		className: 'header__link',
		innerHTML: `
			<svg aria-label="Корзина" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" xmlns="http://www.w3.org/2000/svg">
...
export const favoriteLink = createElement('a', 
	{
		className: 'header__link',
		innerHTML: `
			<svg aria-label="Избранное" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" xmlns="http://www.w3.org/2000/svg">
